      ...
      <main className="relative z-10 flex-grow flex items-center justify-center px-5 py-8 lg:py-16">
        <div className="w-full max-w-[420px] space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm md:text-base text-[#404942] tracking-wide">Update your password</p>
          </div>
          ...
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg border border-[#E5E7EB]/50 transition-all duration-300">
            {submitted ? (
              <div className="text-center space-y-4">
                ...
                <h2 className="text-lg font-bold text-[#0D4C2E]">Password Updated</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <p className="text-xs text-[#404942] leading-normal">
                  Please choose a strong, secure password that you do not use on other online platforms.
                </p>
                ...
                <button
                  type="submit"
                  className="w-full h-12 mt-2 bg-[#0D4C2E] text-white font-bold text-sm tracking-wider uppercase rounded-xl shadow-md hover:bg-[#00341c] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer"
                >
